...
from keras.layers import Conv3D, MaxPooling3D,Input,UpSampling3D,Reshape,ZeroPadding3D,Cropping3D
...
pool1 = MaxPooling3D(pool_size=(2, 2, 2), strides=None, padding='valid', data_format=None)(conv1)
conv2 = conv_bn_relu_1x(32,(3,3,3),pool1)
pool2 = MaxPooling3D(pool_size=(2, 2, 2), strides=None, padding='valid', data_format=None)(conv2)
...
model.fit(input,input, batch_size=None,
          steps_per_epoch=1,
          epochs=2000,
          verbose=1)
